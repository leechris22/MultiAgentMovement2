...
// Define the path class made up of points
[System.Serializable]
public class Path {
    // Define variables
    [SerializeField]
    ...
    // Return if the path is closed or toggle it closed
    ...
    // Automasically repositions the control points
    ...
    // Adds evenly spaced points to a path
    ...
    // Automatically sets all affected control points 
    ...
    // Automatically sets all control points
    ...
    // Automatically sets the control points of an anchor
    ...
    // Automatically sets first and last control points
